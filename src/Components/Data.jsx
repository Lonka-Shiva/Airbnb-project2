import swimmer from "../Images/poster-one.png";
...
export default [
  ...
  },
  {
    ...
    title: "Learn Magic",
    description:
      "Interested in becoming a Magician For beginner and experienced photographers alike, join us in learning techniques required to leave the happy couple with memories that'll last a lifetime.",
    price: 125,
    coverImg: [magic],
    stats: {
      rating: 4.5,
